    ...
    <div className="min-h-screen bg-[#fff9f5]">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-[#5e3023] mb-4">Get In Touch</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            ...
            <div className="bg-white rounded-lg shadow-md p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="flex-shrink-0 h-10 w-10 rounded-full bg-[#f8e8e0] flex items-center justify-center mr-4">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#d3756b]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                    </svg>
                  </div>
                  <div>
                    <h4 className="font-semibold text-[#5e3023]">Our Location</h4>
                    <p className="text-[#8c5f53] mt-1">Main Street, Swat, Pakistan</p>
                    <p className="text-[#8c5f53]">Also in Islamabad, Lahore & Karachi</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#5e3023]">Phone Number</h4>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="font-semibold text-[#5e3023]">Email Address</h4>
                    <p className="text-[#8c5f53] mt-1">info@sweetindulgence.com</p>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="h-10 w-10 rounded-full bg-[#f8e8e0] flex items-center justify-center text-[#d3756b] hover:bg-[#d3756b] hover:text-white transition-colors">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-lg shadow-md p-8">
              <h3 className="text-2xl font-bold text-[#5e3023] mb-6">Send Us a Message</h3>
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      <label htmlFor="phone" className="block text-[#5e3023] font-medium mb-2">
                        Phone Number
                      </label>
                      <input
                        type="tel"
                    ...
                    <div>
                      <label htmlFor="subject" className="block text-[#5e3023] font-medium mb-2">
                        Subject
                      </label>
                      <input
                        type="text"
                  ...
                  <div className="mb-6">
                    <label htmlFor="message" className="block text-[#5e3023] font-medium mb-2">
                      Your Message
                    </label>
                    <textarea
                      id="message"
      ...
      <div className="bg-[#f8e8e0] py-16">
        <div className="max-w-4xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#5e3023] mb-3">Frequently Asked Questions</h2>
            ...
            {[
              {
                ...
                answer: "We recommend placing your order at least 7-10 days in advance for custom cakes. For wedding cakes or large events, please book 3-4 weeks ahead to ensure availability."
              },
              {
                question: "Do you deliver cakes?",
                answer: "Yes, we offer delivery services within city limits. Delivery fees vary based on distance. You can also pick up your order at any of our store locations."
              },
              {
                question: "What if I need to cancel my order?",
                answer: "Cancellations made 48 hours or more before pickup/delivery date are eligible for a full refund. For cancellations within 48 hours, a 50% cancellation fee applies."
              },
              {
                question: "Do you accommodate dietary restrictions?",
                answer: "Absolutely! We offer gluten-free, eggless, and sugar-free options. Please inform us of any allergies or dietary restrictions when placing your order."
              }
            ].map((faq, index) => (
              <div key={index} className="bg-white p-6 rounded-lg shadow-sm">
                <h4 className="text-lg font-bold text-[#5e3023] mb-3">{faq.question}</h4>
          ...
          <div className="text-center mt-10">
            ...
            <button className="bg-[#d3756b] hover:bg-[#c25d52] text-white px-8 py-3 rounded-full font-bold transition-colors inline-flex items-center">
