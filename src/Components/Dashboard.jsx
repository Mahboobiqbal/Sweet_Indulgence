  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="bg-white rounded-lg shadow-md p-6">
        <h1 className="text-2xl font-bold text-[#5e3023] mb-6">Welcome, {user.first_name}!</h1>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Order Summary Card */}
          <div className="bg-[#fff9f5] p-5 rounded-lg border border-[#e7dcca]">
            <h2 className="text-xl font-semibold text-[#5e3023] mb-3">Your Orders</h2>
            <p className="text-[#8c5f53] mb-2">Recent orders: <span className="font-bold">0</span></p>
            <p className="text-[#8c5f53] mb-4">Pending deliveries: <span className="font-bold">0</span></p>
          ...
          {/* Loyalty Points Card */}
          <div className="bg-[#fff9f5] p-5 rounded-lg border border-[#e7dcca]">
            <h2 className="text-xl font-semibold text-[#5e3023] mb-3">Loyalty Points</h2>
            <div className="mb-4">
              <span className="text-3xl font-bold text-[#d3756b]">{user.loyalty_points || 0}</span>
          ...
          {/* Wishlist Card */}
          <div className="bg-[#fff9f5] p-5 rounded-lg border border-[#e7dcca]">
            <h2 className="text-xl font-semibold text-[#5e3023] mb-3">Your Wishlist</h2>
            <p className="text-[#8c5f53] mb-4">Items in wishlist: <span className="font-bold">0</span></p>
            <button className="text-[#d3756b] hover:text-[#c25d52] font-medium">
              View wishlist →
            </button>
          </div>
        ...
        <div className="mt-8">
          <h2 className="text-xl font-semibold text-[#5e3023] mb-4">Recent Activity</h2>
          <div className="bg-[#fff9f5] p-5 rounded-lg border border-[#e7dcca]">
            <p className="text-[#8c5f53] italic">No recent activity to display.</p>
          </div>
        </div>
      </div>
    </div>
