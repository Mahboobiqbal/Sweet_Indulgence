          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden">
              ...
              <button
                ...
                className="absolute left-2 top-1/2 transform -translate-y-1/2 z-10 bg-white/90 hover:bg-white text-[#5e3023] rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110"
              ...
              <button
                ...
                className="absolute right-2 top-1/2 transform -translate-y-1/2 z-10 bg-white/90 hover:bg-white text-[#5e3023] rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-110"
              ...
              <div
                ref={carouselRef}
                className="flex gap-8 overflow-x-auto scrollbar-hide px-4 py-2"
                style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
              >
                {featuredProducts.map((product, index) => (
                  <div
                    key={product.product_id}
                    className="flex-shrink-0 w-80 bg-white rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-all duration-300 cursor-pointer"
